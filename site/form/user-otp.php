        ...
        <div class="container h-100">
            <div class="row justify-content-md-center align-items-center h-100">
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            <h4 class="card-title">Register Verification</h4>
                            <?php
                            ...
                            ?>
                            <form method="POST" action="user-otp.php" class="my-login-validation">
                                ...
                                <div class="form-group m-0">
                                    <button type="submit" name="check" class="btn btn-success btn-block">
                                        Submit
                                    </button>
                                </div>
                            </form>
