                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Table Blogs</h5><span>CRUD</span>
                                </div>
                                <div>
                                    <a href="new.php" class="btn btn-primary active" style="margin: 20px;"
                                        type="button">New</a>
                                </div>
                                <?php
                                // Add New Categories
                                if (isset($_POST['add_blog'])) {
                                    ...
                                    $noi_dung_bv = $_POST['noi_dung_bv'];
                                    date_default_timezone_set('Asia/Ho_Chi_Minh');
                                    $ngay_dang =  date_format(date_create(), 'Y-m-d');
                                    $ma_ad = $fetch_info['ma_ad'];
                                    $anh_bv = $_FILES['anh_bv']['name'];
                                    $anh_bv_tmp = $_FILES['anh_bv']['tmp_name'];
                                    move_uploaded_file($anh_bv_tmp, '../../uploads/' . $anh_bv);
                                    bai_viet_insert($tieu_de, $ngay_dang, $noi_dung_bv, $anh_bv, $ma_ad);
                                    echo '<script type="text/javascript">
                                    msg("Added Blog Successfully!");
                                    </script>';
                                }
                                // Update Blog
                                if (isset($_POST['edit_blog'])) {
                                    ...
                                    $tieu_de = $_POST['tieu_de'];
                                    $noi_dung_bv = $_POST['noi_dung_bv'];
                                    $infor = bai_viet_select_id($ma_bv);
                                    if ($_FILES['anh_bv']['name'] == '') {
                                        $anh_bv = $infor['anh_bv'];
                                    } else {
                                        $anh_bv = $_FILES['anh_bv']['name'];
                                        $anh_bv_tmp = $_FILES['anh_bv']['tmp_name'];
                                    ...
                                    bai_viet_update($ma_bv, $tieu_de, $noi_dung_bv, $anh_bv);
                                    echo '<script type="text/javascript">
