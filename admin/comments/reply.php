                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">List comment</li>
                                </ol>
                            </div>
                            <div class="col-sm-6">
                                <!-- Bookmark Start-->
                                            ...
                                            <table class="table table-styling table-primary">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_GET['id_comment'])) {
                                                        $ma_bl = $_GET['id_comment'];
                                                        $_SESSION['ma_bl'] = $ma_bl;
                                                        $sql = "SELECT * FROM phan_hoi  INNER JOIN khach_hang ON phan_hoi.ma_kh = khach_hang.ma_kh INNER JOIN hang_hoa ON phan_hoi.ma_hh = hang_hoa.ma_hh WHERE ma_bl= '$ma_bl'";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $item['ten_kh'] ?></td>
                                                        <td><?= $item['noi_dung_ph'] ?></td>
                                                        <td><?= $item['ngay_ph'] ?></td>
                                                        <td>
                                                            <a href="delete.php?id_reply=<?= $item['id'] ?>"
