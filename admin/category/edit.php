                                    ...
                                    <form class="theme-form mega-form" method="POST" action="index.php"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="ten_loai" type="text"
                                                placeholder="Enter name category" value="<?= $item['ten_loai'] ?>"
                                                required>
                                            <input class="form-control" name="ma_loai" type="hidden"
                                                placeholder="Enter name category" value="<?= $item['ma_loai'] ?>">
                                        </div>
                                        <div class="mb-3">
