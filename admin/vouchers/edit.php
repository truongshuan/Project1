                                ...
                                <div class="card-body">
                                    <form class="theme-form mega-form" method="POST" action="index.php"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Name Voucher"
                                                required value="Halloween">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="Date" required
                                                value="2/22212312">
                                        </div>
                                        <div class="mb-3">
