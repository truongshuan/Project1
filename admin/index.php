...
$result_bill = mysqli_fetch_assoc($sql);
$sql = mysqli_query($con, "SELECT * FROM khach_hang");
$result_user = mysqli_num_rows($sql);
$sql = mysqli_query($con, "SELECT * FROM hang_hoa");
$result_pd = mysqli_num_rows($sql);
// $sql_product = mysqli_query($conn, "SELECT * FROM `product`");
// $result_product = mysqli_num_rows($sql_product);
                    ...
                    <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                        <div class="card income-card card-secondary">
                            <div class="card-body text-center">
                                ...
                                <h5><?= $result_pd ?></h5>
                                <p>Total Product</p><a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i
                            ...
                            <div class="card-body text-center" style="margin: 20px;">
                                ...
                                <h5><?= $result_user ?></h5>
                                <p>Total User</p><a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i
                                        class="toprightarrow-secondary fa fa-arrow-up me-2"></i>90.54% </a>
                                <div class="parrten">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512"
                                    ...
                                    <table class="table table-bordernone">
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <div class="setting-list">
                                                        <ul class="list-unstyled setting-option">
                                                            <li>
                                                                <div class="setting-primary"><i class="icon-settings">
                                                                    </i></div>
                                                            </li>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                            src="../content/admin/images/dashboard/product-1.png" alt=""
                                                            data-original-title="" title="">
                                                        <div class="media-body"><a href="product-page.html"><span>Yellow
                                                                    New
                                                                    Nike
                                                                    shoes</span></a></div>
                                                    </div>
                                                ...
                                                <td><img class="img-fluid"
                                                        src="../content/admin/images/dashboard/graph-1.png" alt=""
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                            src="../content/admin/images/dashboard/product-2.png" alt=""
                                                            data-original-title="" title="">
                                                        <div class="media-body"><a href="product-page.html"><span>Sony
                                                                    Brand
                                                                    New
                                                ...
                                                <td><img class="img-fluid"
                                                        src="../content/admin/images/dashboard/graph-2.png" alt=""
                                                        data-original-title="" title=""></td>
                                                <td>
                                                    <p>$548526</p>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                            src="../content/admin/images/dashboard/product-3.png" alt=""
                                                            data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid"
                                                        src="../content/admin/images/dashboard/graph-3.png" alt=""
                                                        data-original-title="" title=""></td>
                                                <td>
                                                    <p>$589565</p>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                            src="../content/admin/images/dashboard/product-4.png" alt=""
                                                            data-original-title="" title="">
                                                        <div class="media-body"><a href="product-page.html"><span>Marco
                                                                    M Kely
                                                                    Handbeg</span></a></div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img class="img-fluid"
                                                        src="../content/admin/images/dashboard/graph-4.png" alt=""
                                                        data-original-title="" title=""></td>
                                                <td>
                                                    <p>$125424 </p>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                            src="../content/admin/images/dashboard/product-5.png" alt=""
                                                            data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid"
                                                        src="../content/admin/images/dashboard/graph-5.png" alt=""
                                                        data-original-title="" title=""></td>
                                                <td>
                                                    <p>$112103</p>
                                                </td>
