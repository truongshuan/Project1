...
<head>
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="../content/admin/css/animate.css">
    <link rel="stylesheet" type="text/css" href="../content/admin/css/chartist.css">
    <link rel="stylesheet" type="text/css" href="../content/admin/css/date-picker.css">
    <link rel="stylesheet" type="text/css" href="../content/admin/css/prism.css">
    <link rel="stylesheet" type="text/css" href="../content/admin/css/vector-map.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper">
                        <a href="index.html"><i class="fa-solid fa-leaf" class="img-fluid" style="font-size: 20px;">Gettree</i>
                    </div>
                    <div class="dark-logo-wrapper">
                        <a href="index.html"><i class="fa-solid fa-leaf" class="img-fluid" style="font-size: 20px; color:aliceblue;">Gettree</i></a>
                    </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="../content/admin/images/user/4.jpg" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="../content/admin/images/user/1.jpg" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="../content/admin/images/user/2.jpg" alt="">
        ...
        <div class="page-body-wrapper sidebar-icon">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="../content/admin/images/dashboard/admin.jpg" alt="">
                    ...
                    <div class="main-navbar">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown"><a class="nav-link menu-title link-nav" href="calendar-basic.html"><i data-feather="calendar"></i><span>Calender
                                        </span></a></li>
                                ...
                                <li class="dropdown"><a class="nav-link menu-title link-nav" href="../starter-kit/index.html"><i data-feather="anchor"></i><span>Starter kit
                                        </span></a></li>
                                ...
                                <div class="card-header">
                                    <div class="header-top d-sm-flex align-items-center">
                                        ...
                                        <div class="center-content">
                                            <p class="d-sm-flex align-items-center"><span class="font-primary m-r-10 f-w-700">$859.25k</span><i class="toprightarrow-primary fa fa-arrow-up m-r-10"></i>86% More
                                                than last year</p>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="header-top d-sm-flex align-items-center">
                                                ...
                                                <div class="center-content">
                                                    <p class="d-flex align-items-center"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i>80%
                                                        Growth</p>
                                                </div>
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordernone">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-1.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="../content/admin/images/dashboard/graph-1.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$210326</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-2.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="../content/admin/images/dashboard/graph-2.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$548526</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-3.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="../content/admin/images/dashboard/graph-3.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$589565</p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-4.png" alt="" data-original-title="" title="">
                                                            ...
                                                            <td><img class="img-fluid" src="../content/admin/images/dashboard/graph-4.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$125424 </p>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="media"><img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-5.png" alt="" data-original-title="" title="">
                                                                    <div class="media-body"><a href="product-page.html"><span>Being Human
                                                                                Branded T-Shirt
                                                                            </span></a></div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td><img class="img-fluid" src="../content/admin/images/dashboard/graph-5.png" alt="" data-original-title="" title=""></td>
                                                            <td>
                                                                <p>$112103</p>
                                                            </td>
                                                            <td>
     ...
     &lt;table class="table table-bordernone"&gt;
       ...
       &lt;tbody&gt;
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-1.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="../content/admin/images/dashboard/graph-1.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$210326&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-2.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="../content/admin/images/dashboard/graph-2.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$548526&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-3.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="../content/admin/images/dashboard/graph-3.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$589565&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-4.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="../content/admin/images/dashboard/graph-4.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$125424 &lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="../content/admin/images/dashboard/product-5.png" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="../content/admin/images/dashboard/graph-5.png" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$112103&lt;/p&gt;
           &lt;/td&gt;
                                ...
                                <div class="col-xl-12 box-col-6 des-xl-50">
                                    <div class="card trasaction-sec">
                                        ...
                                        <div class="transaction-totalbal">
                                            <h2> $2,09,352k <span class="ms-3"> <a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i class="toprightarrow-secondary fa fa-arrow-up me-2"></i>98.54%</a></span>
                                            </h2>
                                            <p>Total Balance</p>
                                        </div>
                                        <div class="card-body p-0">
...
&lt;/div&gt;</code></pre>
    ...
    <!-- Plugins JS start-->
    <script src="../content/admin/js/chart/chartist/chartist.js"></script>
    <script src="../content/admin/js/chart/chartist/chartist-plugin-tooltip.js"></script>
    <script src="../content/admin/js/chart/knob/knob.min.js"></script>
    <script src="../content/admin/js/chart/knob/knob-chart.js"></script>
    <script src="../content/admin/js/chart/apex-chart/apex-chart.js"></script>
    <script src="../content/admin/js/chart/apex-chart/stock-prices.js"></script>
    <script src="../content/admin/js/prism/prism.min.js"></script>
    <script src="../content/admin/js/clipboard/clipboard.min.js"></script>
    <script src="../content/admin/js/counter/jquery.waypoints.min.js"></script>
    <script src="../content/admin/js/counter/jquery.counterup.min.js"></script>
    <script src="../content/admin/js/counter/counter-custom.js"></script>
    <script src="../content/admin/js/custom-card/custom-card.js"></script>
    <script src="../content/admin/js/notify/bootstrap-notify.min.js"></script>
    <script src="../content/admin/js/vector-map/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-world-mill-en.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-us-aea-en.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-uk-mill-en.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-au-mill.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-chicago-mill-en.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-in-mill.js"></script>
    <script src="../content/admin/js/vector-map/map/jquery-jvectormap-asia-mill.js"></script>
    <script src="../content/admin/js/dashboard/default.js"></script>
    <script src="../content/admin/js/notify/index.js"></script>
    <script src="../content/admin/js/datepicker/date-picker/datepicker.js"></script>
    <script src="../content/admin/js/datepicker/date-picker/datepicker.en.js"></script>
    <script src="../content/admin/js/datepicker/date-picker/datepicker.custom.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
